...
#Keypress and mouse event responses
...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship,
    ...
    if button_clicked and not stats.game_active:
        ...
        #Hide the mouse while game is active
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
    ...
    #Redraw the screen on each pass through loop
    ...
    pygame.display.flip()
#update bullet positions and clear old bullets    
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship,
    ...
    #Remove bullets and aliens that collided
    ...
    if len(aliens) == 0:
        #If  entire fleet destroyed begin new level
        bullets.empty()
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens,
    ...
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            ...
            break
#Check for edge and update entire fleet            
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    #Create an alien and determine number of aliens in row
    alien = Alien(ai_settings, screen)
